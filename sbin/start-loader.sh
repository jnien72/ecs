...
JVM_OPTS="$JVM_OPTS -XX:HeapDumpPath=logs/server-heap-dump.hprof";
JVM_OPTS="$JVM_OPTS -XX:ErrorFile=logs/server-java-error.log";
JVM_OPTS="$JVM_OPTS -Xloggc:logs/server-gc.log";
JVM_OPTS="$JVM_OPTS -Xmx256m"
JVM_OPTS="$JVM_OPTS -Xms256m"

java -noverify -classpath $CLASSPATH $JVM_OPTS com.test.ecs.EcsLoader